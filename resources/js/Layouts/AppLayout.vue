            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link :href="route('data-covid')" :active="route().current('data-covid')">
                                Data Covid
                            </jet-nav-link>
                        </div>
                        <div v-if="$page.user.tipe_akun === 1" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex sm:items-center">
